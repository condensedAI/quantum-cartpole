...
if __name__ == "__main__":
    ...
    env = gym.make('qcart-v1', potential = 'cosine', k = 67, system = 'quantum', controller = 'elqr', estimator = 'extended_kalman', filter_model = None)
    # env = gym.make('qcart-v1', potential = 'quadratic', k = np.pi, system = 'quantum', controller = 'lqr', estimator = 'kalman', filter_model = None)    
    ...
    resets = []
    for i in range(int(500000//N_meas)):
...
# classical quadratic Kalman + LQR:     passed
# classical cosine Kalman + LQR:        passed
# classical quartic Kalman + LQR:       passed

# quantum quadratic Kalman + LQR:       passed
# quantum cosine Kalman + LQR:          passed
# quantum quartic Kalman + LQR:         passed